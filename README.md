...
8、多模式Mode选择:不同模式敌兵数量和武器模式不同。
9、多模式Mode选择:(投币后上下键选择不同模式Up and down keys to choose different modes after coin insertion)
...
10、试玩下载地址:https://zengfr.gitee.io/home/emu/punisherfr.html (2020.06.01后可在线试玩和rom下载)
11、试玩视频录像:https://space.bilibili.com/492484080/video
12、试玩方法:点击游戏链接,点击开始游戏按钮,开始游戏:默认按键（可自行修改:shift投币+enter开始+4方向按键+按键zxas
